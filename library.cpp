...
string Library::pub_title_to_string(int publication_index){
  return publications[publication_index].to_strtitle();
}
string Library::pub_author_to_string(int publication_index){
  return publications[publication_index].to_strauthor();
}
string Library::pub_copyright_to_string(int publication_index){
  return publications[publication_index].to_strcopyright();
}
string Library::pub_age_to_string(int publication_index){
  return publications[publication_index].to_str_target_age();
}
string Library::pub_genre_to_string(int publication_index){
  return publications[publication_index].to_str_genre();
}
string Library::pub_media_to_string(int publication_index){
  return publications[publication_index].to_str_media();
}
string Library::pub_isbn_to_string(int publication_index){
  return publications[publication_index].to_str_isbn();
}
string Library::pub_ava_to_string(int publication_index){
  return publications[publication_index].to_str_ava();
}
