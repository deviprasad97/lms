...
string  Controller::title_getter(int i){
   string title=view.get_pub_title(i);
   return title;
}
string  Controller::author_getter(int i){
   string author=view.get_pub_author(i);
   return author;
}
string  Controller::copyright_getter(int i){
   string copyright=view.get_pub_copyright(i);
   return copyright;
}

string Controller::age_getter(int i){
  string age=view.get_pub_age(i);
  return age;
}
string Controller::genre_getter(int i){
  string genre=view.get_pub_genre(i);
  return genre;
}
string Controller::media_getter(int i){
  string media=view.get_pub_media(i);
  return media;
}
string Controller::isbn_getter(int i){
  string isbn=view.get_pub_isbn(i);
  return isbn;
}
string Controller::ava_getter(int i){
  string ava=view.get_pub_ava(i);
  return ava;
}
int Controller::pub_size(){
