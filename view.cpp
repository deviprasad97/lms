...
string View::get_pub_title(int i){
  string title = library.pub_title_to_string(i);
  return title;
}
string View::get_pub_age(int i){
  string age = library.pub_age_to_string(i);
  return age;
}
string View::get_pub_genre(int i){
  string genre = library.pub_genre_to_string(i);
  return genre;
}
string View::get_pub_media(int i){
  string media = library.pub_media_to_string(i);
  return media;
}
string View::get_pub_ava(int i){
  string ava = library.pub_ava_to_string(i);
  return ava;
}

string View::get_pub_isbn(int i){
  string isbn = library.pub_isbn_to_string(i);
  return isbn;
}
string View::get_pub_author(int i){
  string author = library.pub_author_to_string(i);
  return author;
}
string View::get_pub_copyright(int i){
  string copyright = library.pub_copyright_to_string(i);
  return copyright;
}
...
int View::get_length(){
  return library.number_of_publications();
}
